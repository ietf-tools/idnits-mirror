  ...
  switch (doc.type) {
    case 'txt': {
      if (!doc.data.markers.abstract.start) {
        ...
        const numericReferencePattern = /\[\d+\]/i
        ...
        validateReference(numericReferencePattern, 'INVALID_ABSTRACT_SECTION_NUM_REF', 'The abstract section should not contain numeric references.')
