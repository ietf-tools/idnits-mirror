...
const INVALID_TERMS_RE = /demultiplexor|diffserv|e[-\s]mail|internet\sdraft|ipsec|(?<!\S)on[-\s]line(?![A-Za-z0-9])|pseudo[-\s]wire|public-key|sub-domain|sub-options|time-stamp|us-ascii/gi
